                    ...
                    <div class="app-sidebar__inner">
                        <?php
                                ...
                                $menuAdmin = [
                                    ...
                                    [
                                        'label' => "<i class='metismenu-icon fa fa-user-secret'></i> <span class='name'>" .Yii::t('app', "Персонал"). "</span>",
                                        'items' => [
                                            [
                                                'label' => Yii::t('app','Курьеры'),
                                                'url' => ["/courier/index"]
                                            ...
                                            [
                                                'label' => Yii::t('app',"Транспорт"),
                                                'url' => ["/transport-new/list"]
                                            ],
                                            [
                                ...
                                $menuSuperAdmin = [
                                    ...
                                    [
                                        'label' => "<i class='metismenu-icon fa fa-user-secret'></i> <span class='name text-capitalize'>".Yii::t('app',"Отдел Кадров")."</span>",
                                        'items' => [
                                            [
                                                'label' => Yii::t('app',"Сотрудники"),
                                                'url' => ["/employee/index"]
